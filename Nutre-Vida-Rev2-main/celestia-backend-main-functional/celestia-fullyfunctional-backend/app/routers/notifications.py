...
async def get_scheduler_status(
    ...
    try:
        ...
        return {
            "scheduler_active": scheduler_status.get("scheduler_running", False),
            "total_users": scheduler_status.get("total_users", 0),
            "verified_users": scheduler_status.get("verified_users", 0),
            "notifications_today": scheduler_status.get("notifications_today", 0),
