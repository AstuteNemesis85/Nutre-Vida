...
def startup_event():
    ...
    # Initialize RAG service and index nutrition knowledge base
    try:
        rag_service = get_rag_service()
        rag_service.initialize()
        print("RAG service initialized with nutrition knowledge base")
    except Exception as e:
        print(f"Warning: RAG service initialization failed (non-fatal): {e}")
...
def health_check():
    ...
    rag_stats = get_rag_service().get_stats()
